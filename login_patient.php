...
<body>
    <nav class="navebar navbar-expand-lg navbar-dark bg-info">
        <div class="container">
        ...
        <div class="col-lg-4">
            <div class="container text-center mt-5">
                ...
                <div class="mb-3 px-lg-2 px-xl-5">
                    <form action="check_login_patient.php" method="post" name="login_form_patient" id="login">
                        <input name="CitizenID" type="text" class="form-control login-form-field mt-4 mb-2" id="exampleFormControlInput1" placeholder="Citizen ID">
                        <input name="Telephone" type="text" class="form-control login-form-field mb-3" id="exampleFormControlInput1" placeholder="Telephone number">
